...
name = "Area for building" # Set layer name in Camel case (e.g. Population Density)
field = "area_xd" # Name of the field to be used from shapefile. Will be ignored if raster.
