...
---------------------------------------------------------------------"""
outputPath = "C:/urscape/Data"  # Do not use any backslash (e.g. C:/Documents/ur-scape/Data)
name = "distance to nearest hospital" # Set layer name in Camel case (e.g. Population Density)
field = "Hubdist" # Name of the field to be used from shapefile. Will be ignored if raster.
resolution = "1" # 0-Neighbourhood, 1-City, 2-Metropolitan, 3-National, 4-Continental, 5-Global

"""Please set metadata"""
units = "m2" # set layer units (e.g. People per Sq km)
location = "HCMC" # set location of layer (e.g. Palembang)
source = "HCM CIREN" # set source of layer (e.g. Statistics Bureau)
date = "2019" # Year of data in format YYYY.MM.DD (month and day are optional)
...
citation = "Data is builded in 2019 from 2005 topographic map" # insert citation - 
mandatoryCitation = True # should the citation be always shown?
link = "www.ciren.vn" # link to dataset if aplied 
"""---------------------------------------------------------------------
